...
public class JavaCodeGenerator extends CodeGenerator {
    ...
    public void gen(ParserGrammar g) throws IOException {
		...
		println("	// ANTXR XML Mode Support");
		println("	private static Map __xml_namespaceMap = new HashMap();");
		println("	public static Map getNamespaceMap() {return __xml_namespaceMap;}");
		println("	public static String resolveNamespace(String prefix) {");
		println("		if (prefix == null || \"\".equals(prefix))");
		println("			return \"\";");
		println("		return (String)__xml_namespaceMap.get(prefix);");
		println("	}");
        if (grammar.namespaceMap != null && !grammar.namespaceMap.isEmpty()) {
			println("	static {");
            for (Iterator i = grammar.namespaceMap.keySet().iterator(); i.hasNext();) {
				String namespacePrefix = (String)i.next();
				String namespace = (String)grammar.namespaceMap.get(namespacePrefix);
