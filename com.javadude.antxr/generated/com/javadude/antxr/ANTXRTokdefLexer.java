// $ANTXR : "tokdef.antxr" -> "ANTXRTokdefLexer.java"$
...
public class ANTXRTokdefLexer extends com.javadude.antxr.CharScanner implements ANTXRTokdefParserTokenTypes, TokenStream
 {
public ANTXRTokdefLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public ANTXRTokdefLexer(Reader in) {
	this(new CharBuffer(in));
}
public ANTXRTokdefLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public ANTXRTokdefLexer(LexerSharedInputState state) {
	super(state);
	...
	public final void mINT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt126>=1 ) { break _loop126; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
