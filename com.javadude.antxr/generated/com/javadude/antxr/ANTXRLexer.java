...
public class ANTXRLexer extends com.javadude.antxr.CharScanner implements ANTXRTokenTypes, TokenStream
 {
...
public ANTXRLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTXRHashString("public", this), new Integer(32));
	literals.put(new ANTXRHashString("class", this), new Integer(10));
	literals.put(new ANTXRHashString("header", this), new Integer(5));
	literals.put(new ANTXRHashString("throws", this), new Integer(37));
	literals.put(new ANTXRHashString("lexclass", this), new Integer(9));
	literals.put(new ANTXRHashString("catch", this), new Integer(40));
	literals.put(new ANTXRHashString("private", this), new Integer(33));
	literals.put(new ANTXRHashString("options", this), new Integer(51));
	literals.put(new ANTXRHashString("extends", this), new Integer(11));
	literals.put(new ANTXRHashString("protected", this), new Integer(31));
	literals.put(new ANTXRHashString("TreeParser", this), new Integer(13));
	literals.put(new ANTXRHashString("Parser", this), new Integer(30));
	literals.put(new ANTXRHashString("Lexer", this), new Integer(12));
	literals.put(new ANTXRHashString("returns", this), new Integer(36));
	literals.put(new ANTXRHashString("charVocabulary", this), new Integer(19));
	literals.put(new ANTXRHashString("tokens", this), new Integer(4));
	literals.put(new ANTXRHashString("exception", this), new Integer(39));
}
	...
	public final void mINT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt447>=1 ) { break _loop447; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
