// $ANTXR : "action.antxr" -> "ActionLexer.java"$
 ...
 */
public class ActionLexer extends com.javadude.antxr.CharScanner implements ActionLexerTokenTypes, TokenStream
 {
...
tryAgain:
	...
	public final void mACTION(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
				...
				if ( _cnt479>=1 ) { break _loop479; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt479++;
		} while (true);
	...
	protected final void mATTRIBUTE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = ATTRIBUTE;
		int _saveIndex;
		Token id1=null;
		...
		mID(true);
		id1=_returnToken;
		attribute=id1.getText();
		{
		if ((LA(1)==':') && (_tokenSet_3.member(LA(2))) && (true)) {
			match(":");
			mID(true);
			id2=_returnToken;
			attribute=id2.getText(); namespace=id1.getText();
		}
		else {
		}
					...
					if (special) {
						if ("line".equals(attribute)) {
							text.setLength(_begin); text.append("__xml_startTag.getLine()");
						} else if ("column".equals(attribute)) {
							text.setLength(_begin); text.append("__xml_startTag.getColumn()");
						} else if ("fileName".equals(attribute)) {
							text.setLength(_begin); text.append("getFilename()");
						} else if ("tagName".equals(attribute)) {
							text.setLength(_begin); text.append("__xml_startTag.getText()");
						}
					} else {
						text.setLength(_begin); text.append("((XMLToken)__xml_startTag).getAttribute(resolveNamespace(\""+namespace+"\"),\""+attribute+"\")");
					}
	...
	protected final void mWS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((LA(1)=='\r') && (LA(2)=='\n') && (true)) {
				...
				if ( _cnt598>=1 ) { break _loop598; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mTEXT_ARG(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_11.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && (true)) {
				...
				if ( _cnt535>=1 ) { break _loop535; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		case '[':
		{
			...
			do {
				if ((LA(1)=='[')) {
					...
					if ( _cnt528>=1 ) { break _loop528; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
				}
 ...
 */
	...
	protected final void mINT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt589>=1 ) { break _loop589; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		case '[':
		{
			...
			do {
				if ((LA(1)=='[')) {
					...
					if ( _cnt549>=1 ) { break _loop549; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
				}
	...
	protected final void mINT_OR_FLOAT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9')) && (_tokenSet_24.member(LA(2))) && (true)) {
				...
				if ( _cnt592>=1 ) { break _loop592; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mSL_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			// nongreedy exit test
			if ((LA(1)=='\n'||LA(1)=='\r') && (true) && (true)) break _loop569;
	...
	protected final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			// nongreedy exit test
			if ((LA(1)=='*') && (LA(2)=='/') && (true)) break _loop573;
			if ((LA(1)=='\r') && (LA(2)=='\n') && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
				match('\r');
				match('\n');
				newline();
