...
public class NoteParser1 extends com.javadude.antxr.LLkParser       implements NoteParser1TokenTypes
 {
	// ANTXR XML Mode Support
	...
	static {
		...
		__xml_namespaceMap.put("$DEFAULT","http://www.w3schools.com");
 }


protected NoteParser1(TokenBuffer tokenBuf, int k) {
  super(tokenBuf,k);
  tokenNames = _tokenNames;
}

public NoteParser1(TokenBuffer tokenBuf) {
  this(tokenBuf,1);
}

protected NoteParser1(TokenStream lexer, int k) {
  super(lexer,k);
  tokenNames = _tokenNames;
}

public NoteParser1(TokenStream lexer) {
  this(lexer,1);
}

public NoteParser1(ParserSharedInputState state) {
  super(state,1);
  tokenNames = _tokenNames;
}
